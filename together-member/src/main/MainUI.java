...
public class MainUI extends JFrame implements ActionListener{
	...
	//	friendsPanel.
		...
		scrollbar.setSize(15,500);
		scrollbar.setLocation(300, 30);
...
class AddFriend extends JFrame{
	...
	public AddFriend() {
		...
		JDialog jDialog = new JDialog(this,"aㅁㄴㅇㄹ"); 
		/*setSize(200,200);
		setVisible(true);*/
...
class Test extends JFrame{ 
	   public Test(){ 
	      ...
	      for(int i=0;i<btns.length;i++){ 
	         ...
	         btns[i].setPreferredSize(new Dimension(30*(i+1),40)); 
	         btns[i].setMaximumSize(new Dimension(30*(i+1),40)); 
	         p.add(btns[i]); 
	      } 
